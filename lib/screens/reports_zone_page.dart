...
class _ReportsZonePageState extends State<ReportsZonePage>
  ...
  Future<void> _downloadMcqReportPdf() async {
    if (!mounted) return;
    ...
    try {
        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) {
            return [
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text('Subject: ${_selectedSubject ?? "All Subjects"}'),
                      pw.Text('Date: $formattedDate'),
                    ],
                  ),
                  pw.Text('Generated by: Achievers App'),
                ],
              ),
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    _buildReportRow('Total Questions', '20'),
                    _buildReportRow('Correct Answers', '16'),
                    _buildReportRow('Incorrect Answers', '4'),
                    _buildReportRow('Score', '80%'),
                    _buildReportRow('Time Spent', '15m 30s'),
                    _buildReportRow('Date Completed', formattedDate),
                  ],
                ),
              ),
              pw.SizedBox(height: 24),
                  ...
                  pw.TableRow(
                    ...
                    children: [
                      pw.Padding(
                        ...
                        child: pw.Text('Category', style: pw.TextStyle(color: PdfColors.white, fontWeight: pw.FontWeight.bold)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8.0),
                        child: pw.Text('Correct', style: pw.TextStyle(color: PdfColors.white, fontWeight: pw.FontWeight.bold), textAlign: pw.TextAlign.center),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8.0),
                        child: pw.Text('Total', style: pw.TextStyle(color: PdfColors.white, fontWeight: pw.FontWeight.bold), textAlign: pw.TextAlign.center),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8.0),
                        child: pw.Text('Score', style: pw.TextStyle(color: PdfColors.white, fontWeight: pw.FontWeight.bold), textAlign: pw.TextAlign.center),
                      ),
                    ],
                  ),
                  _buildTableRow('Algebra', 8, 10, 80),
                  _buildTableRow('Geometry', 5, 6, 83.3),
                  _buildTableRow('Calculus', 3, 4, 75),
                ],
              ),
              pw.SizedBox(height: 24),
              ...
              pw.Center(
                child: pw.Text(
                  'Generated on $formattedDate • Achievers Learning App',
                  style: pw.TextStyle(
                    fontSize: 10,
      ...
      final file = File('${output.path}/mcq_report_${DateTime.now().millisecondsSinceEpoch}.pdf');
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              Text('MCQ report generated successfully!', style: GoogleFonts.poppins()),
            ],
          ),
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              const SizedBox(width: 12),
              Text('Failed to generate MCQ report: ${e.toString()}', style: GoogleFonts.poppins()),
            ],
          ),
  ...
  pw.TableRow _buildTableRow(String category, int correct, int total, double score) {
    return pw.TableRow(
      ...
      children: [
        ...
        pw.Padding(
          padding: const pw.EdgeInsets.all(8.0),
          child: pw.Text(correct.toString(), textAlign: pw.TextAlign.center),
        ),
        pw.Padding(
          padding: const pw.EdgeInsets.all(8.0),
          child: pw.Text(total.toString(), textAlign: pw.TextAlign.center),
        ),
        pw.Padding(
          padding: const pw.EdgeInsets.all(8.0),
          child: pw.Text('${score.toStringAsFixed(1)}%', textAlign: pw.TextAlign.center),
        ),
      ],
    );
  }
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: OutlinedButton.icon(
                                            onPressed: _downloadMcqReportPdf,
                                            style: OutlinedButton.styleFrom(
                                            ...
                                            icon: const Icon(Icons.assignment, size: 20, color: Colors.blue),
                                            label: Text(
                                              'MCQ Report',
                                              style: GoogleFonts.poppins(
                                                color: Colors.blue[900],
